...
let
  # Stylix colors (works when stylix HM module is imported for the user)
  c = config.lib.stylix.colors;

  # Fonts from Stylix if you want them consistent system-wide
  mono = (config.stylix.fonts.monospace.name or "JetBrainsMono Nerd Font Mono");
  sans = (config.stylix.fonts.sansSerif.name or "DejaVu Sans");

  # Helper to build #RRGGBB
  hex = v: "#${v}";
in
{
  programs.waybar = {
